...
import SmokWyglad from "../images/smok-wyglad.jpg"
import SmokWyglad2 from "../images/smok-wyglad-2.jpg"
...
//                             <img className="m-auto mb-5" src={FunkyTitle3} alt="" height={"auto"} width={200}/>
//                         </span>
...
//                                     />
//                                 </figure>
//                                 Osiąga długość od 0,5 do 3 cm. Jego ciało jest spłaszczone i zwęża się ku tyłowi. Ma
//                                 sześć
//                                 rozgałęziających się kończyn (pierwsza para jest szczególnie duża) tworzących tzw.
//                                 ceratę.
//                                 <img src={FunFact} alt="Ciekawostka" width={40} id="shake" data-tooltip-id="my-tooltip"
//                                      className="mx-1"
//                                      data-tooltip-html=
//                                          "<h3>Ciekawostka!</h3>
//                                 Pływa „głową w dół” wykorzystując gaz w swoim żołądku."
//                                 />
//                                 Jest barwy
//                                 srebrzysto-szarej przechodzącej w srebrzysto-błękitną po stronie grzbietowej, a
//                                 granatowo-
//                                 niebieskiej od spodniej. Na głowie ma ciemnoniebieskie paski. W jego gardle znajduje się
//                                 tarka
            ...
            <div style={{marginTop: 0}} className="d-flex flex-row">
                ...
                <div className="d-flex flex-column">
                        <span className="mx-auto mt-5">
                            <img className="m-auto mb-5" src={FunkyTitle3} alt="" height={"auto"} width={170}/>
                        </span>
                    <div style={{marginLeft: 10}} className="container d-flex flex-row w-100">
                        <div className="col-11 my-3 ms-2">
                            <p className="lead" style={{fontSize: 28, marginLeft: 25}}>
                                <figure className="figure float-start me-4" id="scaleImage">
                                        <img src={SmokWyglad} alt="Ciekawostka" width={250} id="scale-image" data-tooltip-id="my-tooltip"
                                             className="rounded"
                                        />
                                    </figure>
                                    Osiąga długość od 0,5 do 3 cm. Jego ciało jest spłaszczone i zwęża się ku tyłowi. Ma
                                ...
                                <figure className="figure float-end me-4" id="scaleImage">
                                    <img src={SmokWyglad2} alt="Ciekawostka" width={250} id="scale-image" data-tooltip-id="my-tooltip"
                                         className="rounded"
                                    />
                                </figure>
                                pokryta rzędami chitynowych zębów. <br/><br/>Wygląda trochę jak kosmita, prawda?
